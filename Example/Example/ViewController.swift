...
class ViewController: UIViewController {
    ...
    @IBAction func startTutorial() {
        ...
        let n2 = SpotlightNode(text: "Moved spotlight to the title using a point and radius", target: .point(CGPoint(x: view.bounds.width / 2.0, y: 44), radius: 50))
        ...
        let n5 = SpotlightNode(text: "", target: .point(CGPoint(x: view.bounds.width / 2.0, y: spotlightLabel.frame.midY), radius: 116))
